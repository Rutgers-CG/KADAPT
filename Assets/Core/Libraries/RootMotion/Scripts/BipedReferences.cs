...
namespace RootMotion {
	...
	public class BipedReferences {
		...
		public static bool AutoDetectReferences(ref BipedReferences references, Transform root, AutoDetectParams autoDetectParams) {
			...
			if (references.isValid && CheckSetup(references, false)) return true;
		 ...
		 * */
		private static bool CheckSpine(BipedReferences references, bool log) {
		 ...
		 * */
		private static bool CheckRootHeight(BipedReferences references, bool log) {
		 ...
		 * */
		private static bool CheckFacingAxis(BipedReferences references, bool log) {
