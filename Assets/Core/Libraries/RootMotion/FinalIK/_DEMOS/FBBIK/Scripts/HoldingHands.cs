...
namespace RootMotion.FinalIK.Demos {
	...
	public class HoldingHands : MonoBehaviour {
		...
		void Start() {
			...
			leftHandChar.solver.leftHandEffector.maintainRelativePositionWeight = 1f;
			leftHandChar.solver.rightHandEffector.maintainRelativePositionWeight = 1f;

			rightHandChar.solver.leftHandEffector.maintainRelativePositionWeight = 1f;
			rightHandChar.solver.rightHandEffector.maintainRelativePositionWeight = 1f;

			// Reach smoothing
			leftHandChar.solver.leftArmChain.reachSmoothing = FBIKChain.ReachSmoothing.Exponential;
			leftHandChar.solver.rightArmChain.reachSmoothing = FBIKChain.ReachSmoothing.Exponential;

			rightHandChar.solver.leftArmChain.reachSmoothing = FBIKChain.ReachSmoothing.Exponential;
			rightHandChar.solver.rightArmChain.reachSmoothing = FBIKChain.ReachSmoothing.Exponential;
		}
