...
namespace RootMotion.FinalIK {
	...
	public class IKSolverLimb : IKSolverTrigonometric {
		...
		/// <summary>
		/// Weight of maintaining the rotation of the third bone as it was in the animation
		/// </summary>
		...
		private Quaternion defaultRootRotation, parentDefaultRotation, bone3RotationBeforeSolve, maintainRotation;
		...
		private Vector3 GetModifiedBendNormal() {
			float weight = bendModifierWeight;// * IKPositionWeight;
			...
			case BendModifier.Target:
				return Quaternion.Slerp(Quaternion.identity, IKRotation * Quaternion.Inverse(defaultRootRotation), weight) * bendNormal;
